...
function PromotionEdit() {
  ...
  const { formatDateTime, getDateTime, StringToDate, formatTime } =
    useDateVal();
  ...
  return (
    <div className="w-full">
      ...
      <div className="mx-auto w-[90%] max-w-[1440px] mt-14 border rounded-lg bg-white">
        <div className="py-10 px-6 text-base font-medium leading-normal">
          ...
          <div className="py-10 px-6 text-gray-700 text-base font-medium leading-normal">
            <div>
              <span className="w-52 mr-6 py-6 inline-block">สร้างเมื่อ</span>
              <span>
                {formatDateTime(String(currentPromotion?.created_at))}
              </span>
            </div>
            <div>
              <span className="w-52 mr-6 py-6 inline-block">แก้ไขล่าสุด</span>
      ...
      <div className="w-[90%] max-w-[1440px] mx-auto flex gap-2 justify-end my-6">
        ...
        <AlertDialog>
          <AlertDialogTrigger>
            <p className="text-gray-700 font-semibold underline hover:cursor-pointer hover:scale-110">
              ลบบริการ
            </p>
          </AlertDialogTrigger>
          <Alert
            name={currentPromotion?.promotion_code}
            id={currentPromotion?.promotion_id}
            title="Promotion Code"
          />
        </AlertDialog>
      </div>
